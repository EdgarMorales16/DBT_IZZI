...
{% macro default__get_incremental_merge_sql(arg_dict) %}
  ...
  {% do return(get_merge_sql(arg_dict["target_relation"], arg_dict["temp_relation"], arg_dict["unique_key"], arg_dict["hash_key_upd"], arg_dict["dest_columns"], arg_dict["incremental_predicates"])) %}
